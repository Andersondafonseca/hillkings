...
const googleAnalyticsInit=`
  ...
  gtag('config', 'G-SP611G9HX8');
`;
// Hash the exact inline source so CSP permits this bootstrap without unsafe-inline.
export const googleAnalyticsCspHash=`'sha256-${createHash('sha256').update(googleAnalyticsInit).digest('base64')}'`;
const googleAnalyticsTag=`<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-SP611G9HX8"></script>
<script>${googleAnalyticsInit}</script>`;
